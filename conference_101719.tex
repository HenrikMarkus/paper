...
\title{Assignment Group 6\\}

\author{\IEEEauthorblockN{1\textsuperscript{st} Henrik Markus Guhl}
\IEEEauthorblockA{\textit{University of South-Eastern Norway} \\}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Adrian Chan Ruud}
\IEEEauthorblockA{\textit{University of South-Eastern Norway} \\}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Alexandra Göppert}
\IEEEauthorblockA{\textit{University of South-Eastern Norway} \\}
}
